...
def test_five_day_drawdown_sets_block(tmp_path):
 ...
 for i,e in enumerate([46500,47000,47500,48000,50000]): db.conn.execute("INSERT INTO account_snapshots(ts_utc,ts_ist,cash,equity,gross,daily_start_equity,drawdown5) VALUES(?,?,?,?,?,?,?)",((now-timedelta(days=i)).isoformat(),now.isoformat(),e,e,0,50000,0))
